...
namespace NsqSharp.Tests
{
    ...
    public class ProducerTest
    {
        ...
        [TestMethod]
        public void RunProducerTests()
        {
            TestProducerConnection();
            TestProducerPublish();
            TestProducerMultiPublish();
            TestProducerPublishAsync();
            TestProducerMultiPublishAsync();
            TestProducerHeartbeat();
            TestProducerReconnect();
        }
        ...
        private void TestProducerReconnect(int publishingThreads, int millisecondsBetweenNsqdShutdown, int shutdownCount)
        {
            ...
            try
            {
                ...
                var publisher = new Producer("127.0.0.1:4150", new ConsoleLogger(LogLevel.Info), new NsqConfig());
