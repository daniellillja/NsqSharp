...
namespace NsqSharp
{
    ...
    {
        bool HandlesOption(NsqConfig c, string option);
        void Set(NsqConfig c, string option, object value);
        void Validate(NsqConfig c);
    }

    internal interface defaultsHandler : configHandler
    {
        void SetDefaults(NsqConfig c);
    }
    ...
    /// </summary>
    public class NsqConfig : IBackoffConfig
    {
        ...
        /// </exception>
        /// <param name="option">The option name. See the <see cref="OptAttribute.Name"/> on <see cref="NsqConfig"/> properties
