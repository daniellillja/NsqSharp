...
namespace NsqSharp.Utils.Extensions
{
    ...
    public static class RNGCryptoServiceProviderExtensions
    {
        ...
        public static double Float64(this RandomNumberGenerator rng)
        {
        ...
        public static int Intn(this RandomNumberGenerator rng, int n)
        {
            if (n <= 0)
        ...
        public static int Int(this RandomNumberGenerator rng)
        {
