...
namespace NsqSharp
{
    ...
    public interface IProducer
    {
        ...
        Task<ProducerResponse> PublishAsync(string topic, byte[] body, params object[] args);
        ...
        /// </param>
        /// <returns>A Task&lt;ProducerResponse&gt; which can be awaited.</returns>
        Task<ProducerResponse> PublishAsync(string topic, string value, params object[] args);
        ...
        /// </param>
        /// <returns>A Task&lt;ProducerResponse&gt; which can be awaited.</returns>
        Task<ProducerResponse> MultiPublishAsync(string topic, IEnumerable<byte[]> bodies, params object[] args);
        ...
        /// <param name="topic">The topic to publish to.</param>
        /// <param name="bodies">The collection of message bodies.</param>
        void MultiPublish(string topic, IEnumerable<byte[]> bodies);
    ...
    public sealed partial class Producer : IConnDelegate, IProducer
    {
        /// <summary>
        ...
        public Producer(string nsqdAddress)
            : this(nsqdAddress, new NsqConfig())
        {
        }
        ...
        public Producer(string nsqdAddress, NsqConfig config)
        ...
        public Producer(string nsqdAddress, ILogger logger)
            : this(nsqdAddress, logger, new NsqConfig(), null)
        {
        }
        ...
        public Producer(string nsqdAddress, ILogger logger, NsqConfig config)
            : this(nsqdAddress, logger, config, null)
        {
        }

        private Producer(string addr, ILogger logger, NsqConfig config, Func<Producer, IConn> connFactory)
        {
