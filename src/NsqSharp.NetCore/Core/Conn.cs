...
namespace NsqSharp.Core
{
    ...
    public partial class Conn : IReader, IWriter, IConn
    {
        ...
        private readonly Chan<MessageResponse> _msgResponseChan;
    ...
    public partial class Conn
    {
        ...
        {
            _msgResponseChan.Send(new MessageResponse { msg = m, cmd = Command.Finish(m.ID), success = true, backoff = true });
        }
        ...
        internal TimeSpan onMessageRequeue(Message m, TimeSpan? delay, bool backoff)
        {
            ...
            _msgResponseChan.Send(new MessageResponse
            {
                msg = m,
